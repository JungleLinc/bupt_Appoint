...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading text-center"><h1>预约界面</h1></div>
...
<!--                        <label for="drp_lastName"><font color="#0" size="4">姓氏</font></label>-->
<!--                        <br>-->
...
<!--                        <br>-->
                    ...
                    <div class="pull-right form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="advisorButton" value="all">全部</button>
...
<?php
if (count($advisors) == 0) {
    echo "<div><label> 当前无可预约教师 </label></div>";
} else {
    ?>
    <div class="container-fluid">
