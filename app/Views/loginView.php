...
<!--    <input id="testAction" type="hidden" value="--><?//=$testAction?><!--"/>-->
    ...
    <div class="container" style="margin-top: 40px">
        <div id="message3" style="visibility: hidden"><label for="message"><font color="#e67e22" size="4"><center>Your tempory password expired. Please reset your password.</center></label></div>
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="center-block">
                                        <img class="profile-img" src="app/Views/img/mavblue.gif" alt="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                        <div class="form-group">
											...
											<span class="input-group-addon"> <i class="glyphicon glyphicon-user"></i></span>
                                                <input type="text" class="form-control" id="email" name="email" placeholder="yourname@bupt.edu.cn">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input id="signIn" type="submit" name="signIn" class="btn btn-lg btn-primary btn-block" value="登录">
                                            <a href="?c=<?php echo $loginController?>&a=<?php echo $forgotPasswordDefaultAction?>" class="btn btn-lg btn-primary btn-block">忘记密码</a>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
