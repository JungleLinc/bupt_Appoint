...
<!--        <li><a href="?c=--><?php //echo $advisingController?><!--&a=--><?php //echo $getAdvisingInfoAction?><!--"><font style="color: #e67e22" size="3">Advising</font></a></li>-->
        <li><a href="?c=<?php echo $registerController?>"><span class="glyphicon glyphicon-user"></span><font style="margin-left:5px; color: #e67e22" size="3">注册</font></a></li>
        <li><a href="?c=<?php echo $loginController?>"><span class="glyphicon glyphicon-log-in"></span><font id="login" style="margin-left:5px; color: #e67e22" size="3">登录</font></a></li>
    </ul>
</div>
</div>
</nav>