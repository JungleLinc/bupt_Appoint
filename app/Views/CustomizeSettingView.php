...
$cutOffTime = $content['data']['cutOffTime'];
...
?>
    ...
    <input id="showAppointmentTypeAction" type="hidden" value="<?php echo $showAppointmentTypeAction ?>"/>
    ...
    <div class="container">
        ...
        <div class="panel panel-default resize center-block">
            ...
            <div class="panel-heading text-center"><h1>个人设置</h1></div>
            ...
            <div class="panel-body resize-body center-block">
                ...
                <div class="panel-body resize-body center-block">
                    <form method="POST">
                        <div class="panel-heading text-center"><h3>邮件推送</h3></div>

                        <div class="form-group">
                            <input type="radio" name="notify" id="radioyes"
                                   value="yes" <?php echo $notificationYes ?>><label for="radioyes">推送</label>
                        </div>
                        <div class="form-group">

                            <input type="radio" name="notify" id="radiono" value="no" <?php echo $notificationNo ?>><label
                                    for="radiono">不推送</label>

                        </div>
                        <div class="panel-footer text-center">
                            <input id="setEmailNotificationsSubmit" type="submit" class="btn-lg" value="提交"/>
                        </div>
