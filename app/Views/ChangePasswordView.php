...
<div class="container">
    ...
    <div class="panel panel-default resize center-block">
        <form method="post">
            ...
            <div class="panel-heading text-center"><h1>修改密码</h1></div>
            ...
            <div class="panel-body resize-body center-block">
                ...
                <div class="form-group">
                    ...
                    <label for="currentpassword"><font color="#0" size="4">原密码</font></label>
                    <br>
                    <input type="password" class="form-control" id="currentPassword" name=currentPassword>

                    <label for="password"><font color="#0" size="4">新密码 (最少8位)</font></label>
                    <br>
                    <input type="password" class="form-control" id="newPassword" name=newPassword>

                    <label for="repeatPassword"><font color="#0" size="4">重复输入新密码</font></label>
                    <br>
            ...
            <div class="panel-footer text-center">
                <input type="submit" class="btn-lg" id="changePasswordSubmit" value="提交">
            </div>
        </form>
    </div>
</div>
