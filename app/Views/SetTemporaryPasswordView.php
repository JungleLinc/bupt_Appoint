...
?>
    ...
    <div class="container">
        ...
        <div class="panel panel-default resize center-block">
            <div class="panel-heading text-center"><h1>设置临时密码失效时长(所有用户有效)</h1></div>
            ...
            <form action="#" method="post" name="setTemporaryPasswordInterval_form" id="setTemporaryPasswordInterval_form" onsubmit="return false;">
                <div class="panel-body resize-body center-block">
                    ...
                    <div class="form-group">
                        <label for="setTemporaryPasswordInterval"><font color="#0" size="4">临时密码失效时长(天)</font></label><br>
                ...
                <div class= "panel-footer text-center">
                    <input id="setTemporaryPasswordIntervalSubmit" type="submit" class="btn-lg" value="提交">
                </div>
            </form>
        </div>
    </div>
