        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="pull-right">
                    <div style="float: right; margin-right: 10px;"><a href="<?php echo $mavAppointUrl?>?c=<?php echo $appointmentController?>&a=<?php echo $showCanceledAppointmentAction?>" class="btn btn-default btn-xs active" role="button">预约取消记录</a></div>
                    <div style="float: right; margin-right: 10px;"><a href="<?php echo $mavAppointUrl?>?c=<?php echo $appointmentController?>&a=<?php echo $showAppointmentAction?>" class="btn btn-default btn-xs" role="button">预约历史记录</a></div>
                </div>
