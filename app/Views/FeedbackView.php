...
<div class="panel panel-default">
    <div class="panel-heading"><h2>反馈信息表</h2></div>
    <div class="panel-body">
            ...
            foreach ($feedbackArray as $feedback) {
                ...
                if ($feedback['isHandled'] == 0) {
                    echo "<button id='feedback_reply_button".$position."' type='button' value='".$position."' data-toggle='modal' data-target='#feedbackReplyModel'  class='btn btn-info btn-block feedbackReplyBtn'>回复</button>";
                } else {
                    echo "<button type='button' disabled='disabled' class='btn btn-default btn-block'>已处理</button>";
                }
                echo "</div>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="button_feedback_reply_submit" type="button" class="btn btn-primary">提交</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal -->
        </div>
