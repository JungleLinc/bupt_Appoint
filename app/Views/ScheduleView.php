            ...
            <ul class="dropdown-menu" role="menu">
                ...
                foreach ($appointmentTypes as $appointmentType) {
                    echo "<li><a href=\"?c=$advisingController&a=$scheduleAction&appType=" . $appointmentType['type'] . "&pname=$pName&advisor_email="
                        . $appointmentType['email'] . "&id1=$id1&duration=" . $appointmentType['duration'] . "\">" . $appointmentType['type'] .
                        " (".$appointmentType['duration']." minutes) ". "</a></li>";
                }
                ?>
            </ul>
            <?php
...
if (count($schedules) != 0) {
    ...
    echo "<div style='margin-top:100px;text-align: center; font-size: 32px'> Sorry </div>";
    echo "<div style='text-align: center; font-size: 16px'>Time remained is less than cut off time</div>";
}
?>
    <br/>
    <br/>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id=addApptTypeLabel">添加预约</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <b>邮箱: </b><br><input type="text" name="email" id="email" value="<?php echo $studentEmail ?>"><br>
                        <b>学号: </b><br><input type="text" name="studentId" id="studentId" value="<?php echo $studentId ?>"> <br>
                        <b>手机: </b><br> <input type="text" name="phoneNumber" id="phoneNumber" value="<?php echo $studentPhone ?>"> <br>
                        <b>备注详情: </b><br><textarea rows=4 columns="10" name="description" id="description"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                        <button type="button" class="btn btn-primary" id="makeAppointment">提交</button>
                    </div>
                </div>
            </div>
        </div>
