...
function mav_mail($subject, $content, $toArray) {
    ...
    include_once ROOT . "/lib/class.phpmailer.php";
    include_once ROOT . "/lib/class.smtp.php";
    $mail = new PHPMailer();
...
function validateStudentId($studentId) {
    return preg_match("#20\\d{8}#", $studentId);// || preg_match("#\\d{10}#", $studentId);
}
